...
# =============================================================================
# SLURM Training Script for Sim(2) Similarity Estimation
# =============================================================================
# Model: LogPolarSim2Net (Fourier-Mellin Transform)
# Config: configs/sim2_similarity.yaml
#
# Usage:
#   sbatch slurm/slurm_sim2_train.sh
#
...
echo "========================================"
echo "Sim(2) Similarity Training"
echo "========================================"
...
echo ""
echo "========================================"
echo "Starting Sim(2) training at $(date)"
echo "Config: configs/sim2_similarity.yaml"
echo "========================================"

# Use unbuffered output for real-time logging
python -u -m src.training.train --config-name=sim2_similarity
