...
#SBATCH --array=0-44
#SBATCH --output=logs/phase1_100ep_%A_%a.out
#SBATCH --error=logs/phase1_100ep_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=ansarimohammedyaqoob01@gmail.com

# Phase 1 Comprehensive Testing: 100 Epochs
#
...
echo "=========================================="
echo "PHASE 1 COMPREHENSIVE TEST - 100 EPOCHS"
echo "=========================================="
...
echo "Running scenario: $SCENARIO (100 epochs)"
echo ""

# Create output directory with date
OUTPUT_DIR="outputs/phase1_100ep_$(date +%Y%m%d)"
mkdir -p "$OUTPUT_DIR"
